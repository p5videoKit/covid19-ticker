...
eff_ticker.prototype.draw_dots = function () {
  ...
  this.fill_dot_color();
  this.draw_dot(x, y, dotSize, dotSize);
...
eff_ticker.prototype.draw_dot = function (a_x, a_y, len_x, len_y) {
  ...
  this.output.bezierVertex(offsetX + scale * 6.8284, offsetY + scale * 3.5, offsetX + scale * 7.5, offsetY + scale * 2.8284, offsetX + scale * 7.5, offsetY + scale * 2);
  this.output.bezierVertex(offsetX + scale * 7.5, offsetY + scale * 1.1716, offsetX + scale * 6.8284, offsetY + scale * 0.5, offsetX + scale * 6, offsetY + scale * 0.5);
  this.output.bezierVertex(offsetX + scale * 5.1716, offsetY + scale * 0.5, offsetX + scale * 4.5, offsetY + scale * 1.1716, offsetX + scale * 4.5, offsetY + scale * 2);
  this.output.bezierVertex(offsetX + scale * 4.5, offsetY + scale * 2.8284, offsetX + scale * 5.1716, offsetY + scale * 3.5, offsetX + scale * 6, offsetY + scale * 3.5);
  this.output.endShape(this.output.CLOSE);

  this.output.beginShape();
  this.output.vertex(offsetX + scale * 6, offsetY + scale * 4.5);
  this.output.bezierVertex(offsetX + scale * 4.4427, offsetY + scale * 4.5, offsetX + scale * 2.8215, offsetY + scale * 4.1431, offsetX + scale * 1.3711, offsetY + scale * 3.5713);
  this.output.vertex(offsetX + scale * 0.6289, offsetY + scale * 5.4285);
  this.output.bezierVertex(offsetX + scale * 1.7048, offsetY + scale * 5.8579, offsetX + scale * 2.8573, offsetY + scale * 6.1468, offsetX + scale * 3.9999, offsetY + scale * 6.3301);
  this.output.vertex(offsetX + scale * 3.9999, offsetY + scale * 7.2004);
  this.output.bezierVertex(offsetX + scale * 4.0849, offsetY + scale * 8.0939, offsetX + scale * 3.6832, offsetY + scale * 8.8974, offsetX + scale * 2.1055, offsetY + scale * 12.0528);
  ...
  this.output.bezierVertex(offsetX + scale * 5.5518, offsetY + scale * 9.6322, offsetX + scale * 5.7658, offsetY + scale * 9.5, offsetX + scale * 5.9999, offsetY + scale * 9.5);
  this.output.bezierVertex(offsetX + scale * 6.234, offsetY + scale * 9.5, offsetX + scale * 6.448, offsetY + scale * 9.6323, offsetX + scale * 6.5527, offsetY + scale * 9.8416);
  ...
  this.output.bezierVertex(offsetX + scale * 7.9149, offsetY + scale * 8.0939, offsetX + scale * 7.9999, offsetY + scale * 7.2004, offsetX + scale * 7.9999, offsetY + scale * 6.3301);
  this.output.bezierVertex(offsetX + scale * 9.1409, offsetY + scale * 6.1471, offsetX + scale * 10.2818, offsetY + scale * 5.8534, offsetX + scale * 11.359, offsetY + scale * 5.4332);
  this.output.vertex(offsetX + scale * 10.6264, offsetY + scale * 3.5723);
  this.output.bezierVertex(offsetX + scale * 9.1728, offsetY + scale * 4.139, offsetX + scale * 7.5595, offsetY + scale * 4.5, offsetX + scale * 6, offsetY + scale * 4.5);
  this.output.endShape(this.output.CLOSE);
};
